...
LINUXDROID_PKG_DEPENDS="ffmpeg, libandroid-glob, libandroid-shmem, libdrm, littlecms, libjpeg-turbo, libcaca, liblua52, libpulseaudio, libx11, libxext, libxinerama, libxss, libxrandr, openal-soft"
LINUXDROID_PKG_CONFLICTS="mpv"
LINUXDROID_PKG_REPLACES="mpv"
